...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQWeakHeap;
...
implements Intro<Comparable> {
     ...
     * To mitigate the risk of Quick Sort's worst-case behavior, Intro Sort monitors the recursion depth during the sorting process.
     * If the depth exceeds a certain threshold, the algorithm switches to
     * Another Sort is Weak Heap Sort.
     ...
     *     and the sorting algorithm switches to another sorting method is Weak Heap Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Weak Heap Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQWeakHeap#IntroDPQWeakHeap() IntroDPQWeakHeap
     */
    public IntroWeakHeap() {}
