...
public class IntroQuick3
     ...
     *     and the sorting algorithm switches to another sorting method is Quick3 Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Quick3 Sort when the recursion depth exceeds a specified
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        quick3(array, left, (right - 1), functional);
    }
    ...
    public <L extends Comparable> void introSortClass(
        ...
        quick3(list, left, right, functional);
    }
}