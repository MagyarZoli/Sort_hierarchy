...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQQuick3;
...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Quick3 Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQQuick3#IntroDPQQuick3() IntroDPQQuick3
     */
    public IntroQuick3() {}
