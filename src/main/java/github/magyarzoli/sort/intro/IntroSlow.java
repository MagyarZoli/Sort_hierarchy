...
public class IntroSlow
     ...
     *     and the sorting algorithm switches to another sorting method is Slow Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Slow Sort when the recursion depth exceeds a specified
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQSlow#IntroDPQSlow() IntroDPQSlow
     */
    public IntroSlow() {}
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        slow(array, left, right, functional);
    }
    ...
    public <L extends Comparable> void introSortClass(
        ...
        slow(list, left, right, functional);
    }
}