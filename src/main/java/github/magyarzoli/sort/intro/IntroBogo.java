...
public class IntroBogo
        extends Bogo
        implements Intro<Comparable> {

    /**
     * <b>Intro Bogo Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Quick Sort and Bogo Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     * The basic idea behind Intro Sort is to start with Quick Sort, which is known for its efficiency on average,
     ...
     *     and the sorting algorithm switches to another sorting method is Bogo Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Bogo Sort when the recursion depth exceeds a specified
