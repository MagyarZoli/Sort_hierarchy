...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Odd-even Merge Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQOddEvenMerge#IntroDPQOddEvenMerge() IntroDPQOddEvenMerge
     */
