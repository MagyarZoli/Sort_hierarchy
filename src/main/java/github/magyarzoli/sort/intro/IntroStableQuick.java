...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQStableQuick;
...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Stable Quick Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQStableQuick#IntroDPQStableQuick() IntroDPQStableQuick
     */
