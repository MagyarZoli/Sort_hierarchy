...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQQuick;
...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Quick Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQQuick#IntroDPQQuick() IntroDPQQuick
     */
    public IntroQuick() {}
