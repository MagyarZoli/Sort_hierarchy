...
public class IntroQuick
     ...
     *     and the sorting algorithm switches to another sorting method is Quick Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Quick Sort when the recursion depth exceeds a specified
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        quick(array, left, (right - 1), functional);
    }
    ...
    public <L extends Comparable> void introSortClass(
        ...
        quick(list, left, right, functional);
    }
}