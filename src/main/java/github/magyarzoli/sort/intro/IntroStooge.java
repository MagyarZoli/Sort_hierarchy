...
public class IntroStooge
     ...
     *     and the sorting algorithm switches to another sorting method is Stooge Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Stooge Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQStooge#IntroDPQStooge() IntroDPQStooge
     */
    public IntroStooge() {}
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        stooge(array, left, right, functional);
    }
    ...
    public <L extends Comparable> void introSortClass(List<L> list, int left, int right, SortFunctional<Comparable> functional) {
        stooge(list, left, right, functional);
    }
}