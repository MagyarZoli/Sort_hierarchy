...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQHeap;
...
implements Intro<Comparable> {
     ...
     *     and the sorting algorithm switches to another sorting method is Heap Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Heap Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQHeap#IntroDPQHeap() IntroDPQHeap
     */
    public IntroHeap() {}
