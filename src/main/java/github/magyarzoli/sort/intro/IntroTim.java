...
public class IntroTim
     ...
     *     and the sorting algorithm switches to another sorting method is Tim Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Tim Sort when the recursion depth exceeds a specified
