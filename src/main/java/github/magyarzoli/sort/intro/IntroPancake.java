...
public class IntroPancake
     ...
     * algorithm with a switch to another sorting algorithm Pancake Sort when the recursion depth exceeds a specified
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQPancake#IntroDPQPancake() IntroDPQPancake
     */
    public IntroPancake() {}
    ...
    public <L extends Comparable> void introSortClass(
        ...
        pancake(list, left, right, functional);
    }
}