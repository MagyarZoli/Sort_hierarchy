 ...
 * Another Sort is Merge Sort.
 * @since       1.3
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroMerge
        extends Merge
        implements Intro<Comparable> {

    /**
     * <b>Intro Merge Sort:</b><br>
     ...
     *     and the sorting algorithm switches to another sorting method is Merge Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Merge Sort when the recursion depth exceeds a specified
