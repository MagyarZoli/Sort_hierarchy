...
/**
 * IntroDPQ (Dual Pivot Quick) Merge In Place Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Merge In Place Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge In Place Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Merge In Place Sort, which has good performance
...
public class IntroDPQMergeInPlace
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge In Place Sort monitors
