...
/**
 * IntroDPQ (Dual Pivot Quick) Slow Sort is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Slow Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Slow Sort monitors the recursion depth during the sorting process.
...
public class IntroDPQSlow
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Slow Sort, which has good performance for small input sizes.<br><br>
     * <b>Example:</b>
     * <ol>
