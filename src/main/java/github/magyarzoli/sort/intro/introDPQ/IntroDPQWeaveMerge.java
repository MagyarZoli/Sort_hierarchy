...
/**
 * IntroDPQ (Dual Pivot Quick) Weave Merge Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Weave Merge Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Weave Merge Sort monitors the recursion
 ...
 * Additionally, for small subarrays, Intro switches to Weave Merge Sort, which has good performance
 * for small input sizes.
 * @since       1.1
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQWeaveMerge
        extends IntroWeaveMerge
        implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Weave Merge Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Weave Merge Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Weave Merge Sort monitors the
     ...
     *     it directly to sort the sub-array using a Intro Weave Merge sorting algorithm.
