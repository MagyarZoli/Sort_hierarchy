...
/**
 * IntroDPQ (Dual Pivot Quick) Dual Pivot Quick Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Dual Pivot Quick Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Dual Pivot Quick Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Dual Pivot Quick Sort, which has good performance for
 * small input sizes.
 * @since       1.1
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQDualPivotQuick
        extends IntroDualPivotQuick
        implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Quick3 Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Dual Pivot Quick Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Dual Pivot Quick Sort monitors
     * the recursion depth during the sorting process.
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Dual Pivot Quick Sort, which has good
     ...
     *     it directly to sort the sub-array using a Intro Dual Pivot Quick sorting algorithm.
