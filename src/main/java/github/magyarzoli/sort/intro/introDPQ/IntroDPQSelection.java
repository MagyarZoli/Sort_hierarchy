...
/**
 * IntroDPQ (Dual Pivot Quick) Selection Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Selection Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Selection Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Selection Sort, which has good performance
