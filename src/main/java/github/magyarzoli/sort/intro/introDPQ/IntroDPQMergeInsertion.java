...
/**
 * IntroDPQ (Dual Pivot Quick) Merge Insertion Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Merge Insertion Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge Insertion Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Merge Insertion Sort, which has good performance
...
public class IntroDPQMergeInsertion
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Merge Insertion Sort, which has good performance for
