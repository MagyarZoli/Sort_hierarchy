...
/**
 * IntroDPQ (Dual Pivot Quick) Bozo Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Bozo Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Bozo Sort monitors the
...
public class IntroDPQBozo
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Bozo Sort, which has good performance
