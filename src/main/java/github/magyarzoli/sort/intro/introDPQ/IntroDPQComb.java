...
/**
 * IntroDPQ (Dual Pivot Quick) Comb Sort is a hybrid sorting algorithm that combines the strengths of Dual Pivot
 * Quick Sort and Comb Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Comb Sort monitors the recursion depth
 ...
 * Additionally, for small subarrays, Intro switches to Comb Sort, which has good performance for small input sizes.
 * @since       1.1
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQComb
        extends IntroComb
        implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Comb Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Comb Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Comb Sort monitors the recursion
     * depth during the sorting process.
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Comb Sort, which has good performance for small
     * input sizes.<br><br>
     * <b>Example:</b>
     * <ol>
     ...
     *     it directly to sort the sub-array using a Intro Comb sorting algorithm.
