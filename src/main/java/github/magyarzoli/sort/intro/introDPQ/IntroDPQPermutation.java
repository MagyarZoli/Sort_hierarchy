...
/**
 * IntroDPQ (Dual Pivot Quick) Permutation Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Permutation Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Permutation Sort monitors the recursion
 ...
 * Additionally, for small subarrays, Intro switches to Permutation Sort, which has good performance for
 * small input sizes.
 * @since       1.3
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQPermutation
        extends IntroPermutation
        implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Permutation Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Permutation Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     * The basic idea behind Intro Sort is to start with Dual Pivot Quick Sort, which is known for its
     * efficiency on average,
     ...
     *     it directly to sort the sub-array using a Intro Permutation sorting algorithm.
