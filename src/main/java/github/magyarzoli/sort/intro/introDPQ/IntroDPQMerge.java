...
/**
 * IntroDPQ (Dual Pivot Quick) Merge Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Merge Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Merge Sort, which has good performance
