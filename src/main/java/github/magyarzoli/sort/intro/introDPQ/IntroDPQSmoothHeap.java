...
/**
 * IntroDPQ (Dual Pivot Quick) Smooth Heap Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Smooth Heap Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Smooth Heap Sort monitors the
 ...
 * Additionally, for small subarrays, Intro switches to Smooth Heap Sort, which has good performance
 * for small input sizes.
 * @since       1.1
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQSmoothHeap
        extends IntroSmoothHeap
        implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Smooth Heap Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Smooth Heap Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Smooth Heap Sort monitors
     ...
     *     it directly to sort the sub-array using a Intro Smooth Heap sorting algorithm.
