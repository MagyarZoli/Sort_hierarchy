...
/**
 * IntroDPQ (Dual Pivot Quick) Gnome Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Gnome Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Gnome Sort monitors the
...
public class IntroDPQGnome
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Gnome Sort, which has good performance
