...
/**
 * IntroDPQ (Dual Pivot Quick) Merge3 Sort is a hybrid sorting algorithm that combines the strengths of
 * Dual Pivot Quick Sort and Merge3 Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge3 Sort monitors the recursion depth
 ...
 * Additionally, for small subarrays, Intro switches to Merge3 Sort, which has good performance
...
public class IntroDPQMerge3
     ...
     * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge3 Sort monitors the
