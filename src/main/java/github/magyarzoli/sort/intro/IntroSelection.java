 ...
 * Another Sort is Selection Sort.
 * @since       1.3
...
public class IntroSelection
     ...
     *     and the sorting algorithm switches to another sorting method is Selection Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Selection Sort when the recursion depth exceeds a specified
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        selection(array, left, right, functional);
    }
    ...
    public <L extends Comparable> void introSortClass(
        ...
        selection(list, left, right, functional);
    }
}