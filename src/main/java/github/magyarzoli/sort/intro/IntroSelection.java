...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQSelection;
...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Selection Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQSelection#IntroDPQSelection() IntroDPQSelection
     */
