...
public class IntroTernaryHeap
     ...
     *     and the sorting algorithm switches to another sorting method is Ternary Heap Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Ternary Heap Sort when the recursion depth exceeds a
