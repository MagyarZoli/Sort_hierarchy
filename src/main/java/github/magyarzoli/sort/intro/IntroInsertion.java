 ...
 * Another Sort is Insertion Sort.
 * @since       1.3
...
public class IntroInsertion
     ...
     *     and the sorting algorithm switches to another sorting method is Insertion Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Insertion Sort when the recursion depth exceeds a specified
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQInsertion#IntroDPQInsertion() IntroDPQInsertion
     */
    public IntroInsertion() {}
