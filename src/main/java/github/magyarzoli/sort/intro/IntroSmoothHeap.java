...
import github.magyarzoli.sort.intro.introDPQ.IntroDPQSmoothHeap;
...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Smooth Heap Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         IntroDPQSmoothHeap#IntroDPQSmoothHeap() IntroDPQSmoothHeap
     */
