 ...
 * Another Sort is Smooth Heap Sort.
 * @since       1.3
...
public class IntroSmoothHeap
     ...
     *     and the sorting algorithm switches to another sorting method is Smooth Heap Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Smooth Heap Sort when the recursion depth exceeds a
    ...
    public void introSortClass(Comparable[] array, int left, int right, SortFunctional<Comparable> functional) {
        smooth(array, left, right, functional);
    }
    ...
    public <L extends Comparable> void introSortClass(
        ...
        smooth(list, left, right, functional);
    }
}