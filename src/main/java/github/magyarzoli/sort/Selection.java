...
implements SelectionInterface<Comparable> {
     ...
     * Stability:               <b>No</b>
     * @see         IntroSelection#IntroSelection() IntroSelection
     * @see         Bubble#Bubble() Bubble
     * @see         DoubleSelection#DoubleSelection() DoubleSelection
     * @see         Pancake#Pancake() Pancake
     */
    public Selection() {}
