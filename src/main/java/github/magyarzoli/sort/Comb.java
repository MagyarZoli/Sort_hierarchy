 ...
 * It works by repeatedly comparing and swapping elements with a specific gap value, gradually reducing the gap until
 * it reaches 1, at which point the algorithm performs a final pass similar to Bubble Sort.
 * @since       1.3
...
public class Comb
     ...
     * It works by repeatedly comparing and swapping elements with a specific gap value, gradually reducing the gap
     * until it reaches 1,
     ...
     *     <li>Once the gap becomes 1, perform a final pass similar to Bubble Sort, comparing adjacent elements and
     *     swapping them if necessary.</li>
     ...
     * By gradually reducing the gap, Comb Sort helps bring such elements closer to their correct positions earlier in
     * the sorting process.<br><br>
     * Comb Sort has a time complexity of <em>O(n^2)</em> in the worst case,
     * but it can be improved to have an average time complexity of <em>O(n log(n))</em> by using an optimal shrink
     * factor.<br><br>
     * Comb Sort is an in-place sorting algorithm, meaning it requires only a constant amount of additional memory
     * beyond the original list.
     * It is relatively easy to implement and can be useful in certain scenarios where simplicity and memory efficiency
     * are priorities.<br><br>
     * <b>Property:</b><br>
     ...
     * Stability:               <b>Yes</b>
     * @see         IntroComb#IntroComb() IntroComb
     */
    public Comb() {}
    ...
    /**
     * {@code combInc} that implements the comb sort algorithm to sort an array of {@link java.lang.Comparable
     * Comparable} objects in increasing order.
     * <ul>
     *     <li>The method takes an array of {@code Comparable} objects, denoted by {@code array}, and performs the comb
     *     sort algorithm on it.</li>
     *     <li>The variable {@code n} is assigned the length of the array, representing the total number of elements in
     *     the array.</li>
     *     <li>The variable {@code gap} is initially set to {@code n}, representing the initial gap value for
     *     comparisons and swaps.</li>
     *     <li>The swapped variable is initially set to {@code true}, indicating that there may be swaps to perform in
     *     the array.</li>
     *     <li>The outer {@code while} loop continues as long as the gap is not equal to 1 or there are still swaps
     *     being made in the array.</li>
     *     <li>Inside the {@code while} loop, the {@code getNextGap} method is called to calculate the next gap value
     *     based on the current gap.</li>
     *     <li>The {@code for} loop iterates from 0 to {@code (n - gap)}, performing comparisons and swaps between
     *     elements with a specific gap.</li>
     *     <li>Inside the {@code for} loop, the {@code isSwap} method is called to determine if a swap is necessary
     *     between two elements with the given gap.
     *     If a swap is made, the swapped variable is set to {@code true}.</li>
     *     <li>After the {@code for} loop, the outer {@code while} loop continues until the gap becomes 1 and no more
     *     swaps are made in the array.</li>
     * </ul>
    ...
    /**
     * {@code combDec} that implements the comb sort algorithm to sort an array of {@link java.lang.Comparable
     * Comparable} objects in decreasing order.
     * <ul>
     *     <li>The method takes an array of {@code Comparable} objects, denoted by {@code array}, and performs the
     *     comb sort algorithm on it.</li>
     *     <li>The variable {@code n} is assigned the length of the array, representing the total number of elements in
     *     the array.</li>
     *     <li>The variable {@code gap} is initially set to {@code n}, representing the initial gap value for
     *     comparisons and swaps.</li>
     ...
     *     occurred.</li>
     *     <li>The method enters a while loop that continues until {@code gap} is equal to <i>1</i> and no swaps
     *     are made.</li>
     ...
     *     <li>The method takes an array of {@code Comparable} objects, denoted by {@code array}, and performs the
     *     comb sort algorithm on it.</li>
     *     <li>The variable {@code right} is assigned the length of the array, representing the total number of
     *     elements in the array.</li>
     *     <li>The variable {@code gap} is initially set to {@code right}, representing the initial gap value for
     *     comparisons and swaps.</li>
     ...
     *     <li>Inside the {@code while} loop, the {@code getNextGap} method is called to calculate the next gap value
     *     based on the current gap.</li>
     *     <li>The {@code for} loop iterates from 0 to {@code (right - gap)}, performing comparisons and swaps between
     *     elements with a specific gap.</li>
     *     <li>Inside the {@code for} loop, the {@code isSwap} method is called to determine if a swap is necessary
     *     between two elements with the given gap.
     *     If a swap is made, the swapped variable is set to {@code true}.</li>
     ...
     *     <li>It initializes a boolean variable {@code swapped} to {@code true} to indicate that a swap has
     *     occurred.</li>
     *     <li>The method enters a while loop that continues until {@code gap} is equal to <i>1</i> and no swaps are
     *     made.</li>
     *     <li>Inside the loop, it updates the value of {@code gap} by calling the {@code getNextGap} method.
    ...
    /**
     * {@code combInc} that implements the comb sort algorithm to sort a list of {@link java.lang.Comparable Comparable}
     * objects in increasing order.
     * <ul>
     *     <li>The method takes an list of {@code Comparable} objects, denoted by {@code list}, and performs the comb
     *     sort algorithm on it.</li>
     *     <li>The variable {@code n} is assigned the length of the list, representing the total number of elements in
     *     the list.</li>
     *     <li>The variable {@code gap} is initially set to {@code n}, representing the initial gap value for
     *     comparisons and swaps.</li>
     *     <li>The swapped variable is initially set to {@code true}, indicating that there may be swaps to perform in
    ...
    /**
     * {@code combDec} that implements the comb sort algorithm to sort a list of {@link java.lang.Comparable Comparable}
     * objects in decreasing order.
     * <ul>
     *     <li>The method takes an list of {@code Comparable} objects, denoted by {@code list}, and performs the comb
     *     sort algorithm on it.</li>
     *     <li>The variable {@code n} is assigned the length of the list, representing the total number of elements in
     ...
     *     <li>The method takes an list of {@code Comparable} objects, denoted by {@code list}, and performs the comb
     *     sort algorithm on it.</li>
     *     <li>The variable {@code right} is assigned the length of the list, representing the total number of elements
     *     in the list.</li>
     *     <li>The variable {@code gap} is initially set to {@code right}, representing the initial gap value for
     *     comparisons and swaps.</li>
     *     <li>The swapped variable is initially set to {@code true}, indicating that there may be swaps to perform in
     ...
     * @see         SortSwap#isSwap(List, int, int, SortFunctional)
     */
    protected <L extends Comparable> void comb(
     ...
     * The gap value determines the interval between elements being compared and swapped during each iteration of
     * the sort.
     * <ul>
     *     <li>The method takes an integer {@code gap} as input and calculates the next gap value to be used.</li>
     *     <li>The expression {@code gap = ((gap * 10) / 13)} calculates the next {@code gap} by multiplying the
     *     current gap by 10 and then dividing it by 13.
     ...
     * </ul>
     * {@code getNextGap} method is commonly used in comb sort algorithms to determine the next gap value during each
     * iteration.
