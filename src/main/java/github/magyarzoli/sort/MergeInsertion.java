...
implements InsertionInterface<Comparable> {
     ...
     * Stability:               <b>Yes</b>
     * @see         IntroMergeInsertion#IntroMergeInsertion() IntroMergeInsertion
     */
     ...
     * @param       array to be arranged.
     * @see         MergeInsertion#mergeInsertionInc(Comparable[], int, int)
     */
     ...
     * as it has a lower constant factor and performs fewer comparisons and swaps.
     * @param       array to be arranged.
     * @see         MergeInsertion#mergeInsertionDec(Comparable[], int, int)
     */
     ...
     * @param       array to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         MergeInsertion#mergeInsertion(Comparable[], int, int, SortFunctional)
     */
