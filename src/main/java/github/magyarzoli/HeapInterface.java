...
extends Sorter<T>, SortSwap<T> {
     ...
     * @see         HeapInterface#heapify(Comparable[], int, int, SortFunctional)
     * @see         SortSwap#swap(Comparable[], int, int)
     */
     ...
     * @see         HeapInterface#heapSplitInc(Comparable[], int, int)
     * @see         HeapInterface#heapifyInc(Comparable[], int, int)
     * @see         SortSwap#swap(Comparable[], int, int)
     */
     ...
     * @param       n of the array.
     * @param       i the current element
     * @see         HeapInterface#heapSplitDec(Comparable[], int, int)
     * @see         HeapInterface#heapifyDec(Comparable[], int, int)
     * @see         SortSwap#swap(Comparable[], int, int)
     */
     ...
     * @param       i the current element
     * @param       functional lambda expression for comparison.
     * @see         HeapInterface#heapSplit(Comparable[], int, int, SortFunctional)
     * @see         SortSwap#swap(Comparable[], int, int)
     */
     ...
     */
    default <L extends T> void heapInc(List<L> list) {
        int n = list.size();
        for (int i = ((n / 2) - 1); i >= 0; i--) {
            heapifyInc(list, n, i);
        }
     ...
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapDec(List<L> list) {
        int n = list.size();
        for (int i = ((n / 2) - 1); i >= 0; i--) {
            heapifyDec(list, n, i);
        }
     ...
     *     <li>Within each iteration, it calls the {@code heapify} method to rearrange the elements in
     *     the {@code list} and maintain the heap property starting from index {@code i}.</li>
     ...
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         HeapInterface#heapify(List, int, int, SortFunctional)
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heap(List<L> list, SortFunctional<T> functional) {
        int n = list.size();
        for (int i = ((n / 2) - 1); i >= 0; i--) {
            heapify(list, n, i, functional);
        }
        for (int i = (n - 1); i > 0; i--) {
            swap(list, 0, i);
            heapify(list, i, 0, functional);
        }
    }
     ...
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapInc(List<L> list, int from, int to) {
        for (int i = ((to / 2) - 1); i >= from; i--) {
            heapifyInc(list, to, i);
        }
        for (int i = (to - 1); i > from; i--) {
            swap(list, from, i);
            heapifyInc(list, i, from);
        }
    }
     ...
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapDec(List<L> list, int from, int to) {
        for (int i = ((to / 2) - 1); i >= from; i--) {
            heapifyDec(list, to, i);
        }
        for (int i = (to - 1); i > from; i--) {
            swap(list, from, i);
            heapifyDec(list, i, from);
        }
    }
     ...
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heap(List<L> list, int from, int to, SortFunctional<T> functional) {
        for (int i = ((to / 2) - 1); i >= from; i--) {
            heapify(list, to, i, functional);
        }
        for (int i = (to - 1); i > from; i--) {
            swap(list, from, i);
            heapify(list, i, from, functional);
        }
    }
     ...
     *     is maintained throughout the entire heap structure.</li>
     * </ul>
     * {@code heapifyInc} method is used to transform an list into a max heap by recursively rearranging
     * the elements based on their values and their relationships with their child elements.
     * @param       list to be arranged.
     * @param       n of the list.
     * @param       i the current element
     * @see         HeapInterface#heapSplitInc(List, int, int)
     * @see         HeapInterface#heapifyInc(List, int, int)
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapifyInc(List<L> list, int n, int i) {
        int largest = heapSplitInc(list, n, i);
        if (largest != i) {
            swap(list, i, largest);
            heapifyInc(list, n, largest);
        }
    }
     ...
     *     is maintained throughout the entire heap structure.</li>
     * </ul>
     * {@code heapifyDec} method is used to transform an list into a max heap by recursively rearranging
     * the elements based on their values and their relationships with their child elements.
     * @param       list to be arranged.
     * @param       n of the list.
     * @param       i the current element
     * @see         HeapInterface#heapSplitDec(List, int, int)
     * @see         HeapInterface#heapifyDec(List, int, int)
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapifyDec(List<L> list, int n, int i) {
        int largest = heapSplitDec(list, n, i);
        if (largest != i) {
            swap(list, i, largest);
            heapifyDec(list, n, largest);
        }
    }
     ...
     * @param       i the current element
     * @param       functional lambda expression for comparison.
     * @see         HeapInterface#heapSplit(List, int, int, SortFunctional)
     * @see         SortSwap#swap(List, int, int)
     */
    default <L extends T> void heapify(List<L> list, int n, int i, SortFunctional<T> functional) {
        int largest = heapSplit(list, n, i, functional);
        if (largest != i) {
            swap(list, i, largest);
            heapify(list, n, largest, functional);
        }
    }
     ...
     */
    default <L extends T> int heapSplitInc(List<L> list, int n, int i) {
        int left = ((2 * i) + 1), right = ((2 * i) + 2), largest = heapChildInc(list, n, i, left);
     ...
     */
    default <L extends T> int heapSplitDec(List<L> list, int n, int i) {
        int left = ((2 * i) + 1), right = ((2 * i) + 2), largest = heapChildDec(list, n, i, left);
     ...
     */
    default <L extends T> int heapSplit(List<L> list, int n, int i, SortFunctional<T> functional) {
        int left = ((2 * i) + 1), right = ((2 * i) + 2), largest = heapChild(list, n, i, left, functional);
     ...
     */
    @SuppressWarnings("unchecked")
    default <L extends T> int heapChildInc(List<L> list, int n, int result, int child) {
        if ((child < n) && (list.get(child).compareTo(list.get(result)) > 0)) {
            result = child;
        }
        return result;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <L extends T> int heapChildDec(List<L> list, int n, int result, int child) {
        if ((child < n) && (list.get(child).compareTo(list.get(result)) < 0)) {
            result = child;
        }
        return result;
     ...
     *     and if the comparison condition in {@code functionalCompareTo}
     *     is satisfied between {@code list[child]} and {@code list[result]}.</li>
     *     <li>If the condition is {@code true},
     *     it updates the result variable with the value of {@code child}.</li>
     *     <li>Finally, it returns the value of {@code result}.</li>
     * </ul>
     ...
     * @see         SortFunctional#functionalCompareTo(Comparable, Comparable)
     */
    default <L extends T> int heapChild(List<L> list, int n, int result, int child, SortFunctional<T> functional) {
        if ((child < n) && (functional.functionalCompareTo(list.get(child), list.get(result)))) {
            result = child;
        }
        return result;
    }
