...
public interface SelectionInterface<T extends Comparable>
    ...
    /**
     * {@code selectionInc} that performs the Selection Sort algorithm on an array of {@link java.lang.Comparable
     * Comparable} objects.
     * The sorting is done in ascending order.
     * <ul>
     *     <li>The method takes in an array of Comparable objects, {@code array}, and performs the Selection Sort
     *     algorithm on it.</li>
     *     <li>The method starts by defining the length of the {@code array} as {@code n}.</li>
     *     <li>The outer loop runs from 0 to {@code (n - 1)} and represents the current position of the sorted portion
     *     of the array.</li>
     ...
     *     <li>The inner loop runs from {@code (i + 1)} to {@code (n - 1)} and iterates over the remaining unsorted
     *     portion of the array.</li>
     *     <li>Inside the inner loop, the {@code minIndex} method is called to find the index of the minimum element
     *     between
     *     the current index {@code j} and the current minimum {@code index} index.</li>
     *     <li>After the inner loop completes, the minimum element in the unsorted portion of the array is found, and
     *     its index is stored in {@code index}.</li>
     ...
     * </ul>
     * {@code selectionInc} method implements the Selection Sort algorithm to sort the given {@code array} of Comparable
    ...
    /**
     * {@code selectionDec} that performs the Selection Sort algorithm on an array of {@link java.lang.Comparable
     * Comparable} objects.
     ...
     *     <li>The inner loop runs from {@code (i + 1)} to {@code (n - 1)} and iterates over the remaining unsorted
     *     portion of the array.</li>
     *     <li>Inside the inner loop, the {@code maxIndex} method is called to find the index of the maximum element
     *     between
     *     the current index {@code j} and the current maximum {@code index} index.</li>
     *     <li>After the inner loop completes, the maximum element in the unsorted portion of the array is found, and
     *     its index is stored in {@code index}.</li>
     *     <li>The {@code swap} method is called to swap the elements at indices {@code index} and {@code i}.
     *     This places the maximum element in its correct sorted position.</li>
     *     <li>The process repeats until the entire array is sorted.</li>
     * </ul>
     * {@code selectionDec} method implements the Selection Sort algorithm to sort the given {@code array} of Comparable
    ...
    /**
     * {@code selection} method takes an array {@code array} of type {@code T} and an instance of
     * {@code SortFunctional<T>} as parameters.
     * <ul>
     ...
     *     <li>Within the outer loop, it declares a variable {@code index} and initializes it with the value of
     *     {@code i}.
     ...
     *     <li>The value of {@code index} is updated with the returned index from the {@code findValueIndex}
     *     method.</li>
     ...
     * </ul>
     * {@code selection} this method is to perform selection sort on the {@code array} using the comparison logic
     * defined by the {@code mz.SortFunctional} instance.
     * It iterates through the array and selects the minimum element in each iteration, swapping it with the current
     * position.
     ...
     *     <li>The outer loop runs from {@code left} to {@code (right - 1)} and represents the current position of the
     *     sorted portion of the array.</li>
     *     <li>Inside the outer loop, an integer variable {@code index} is initialized with the value of {@code i}.
     *     This {@code index} represents the index of the minimum element in the unsorted portion of the array.</li>
     *     <li>The inner loop runs from {@code (i + 1)} to {@code (right - 1)} and iterates over the remaining unsorted
     *     portion of the array.</li>
     *     <li>Inside the inner loop, the {@code minIndex} method is called to find the index of the minimum element
     *     between
     *     the current index {@code j} and the current minimum {@code index} index.</li>
    ...
    /**
     * {@code selection} method takes an array {@code array} of type {@code T}, two integer parameters {@code left} and
     * {@code right},
     ...
     *     This loop represents the pass for selecting the minimum element in each iteration within the specified range
     *     of indices.</li>
     *     <li>Within the outer loop, it declares a variable {@code index} and initializes it with the value of
     *     {@code i}.
     *     This variable will keep track of the index of the minimum element found within the specified range.</li>
     *     <li>It enters an inner {@code for} loop that starts from {@code (i + 1)} and iterates until
     *     {@code (j < right)}.
     *     This loop is responsible for finding the index of the minimum element within the specified range starting
     *     from {@code j}.</li>
     ...
     *     <li>The outer loop continues until all elements within the specified range have been sorted in ascending
     *     order.</li>
     * </ul>
    ...
    /**
     * {@code selectionInc} that performs the Selection Sort algorithm on a list of {@link java.lang.Comparable
     * Comparable} objects.
     * The sorting is done in ascending order.
     * <ul>
     *     <li>The method takes in an list of Comparable objects, {@code list}, and performs the Selection Sort
     *     algorithm on it.</li>
     ...
     *     <li>The inner loop runs from {@code (i + 1)} to {@code (n - 1)} and iterates over the remaining unsorted
     *     portion of the list.</li>
     *     <li>Inside the inner loop, the {@code minIndex} method is called to find the index of the minimum element
     *     between
     *     the current index {@code j} and the current minimum {@code index} index.</li>
     *     <li>After the inner loop completes, the minimum element in the unsorted portion of the list is found, and
     *     its index is stored in {@code index}.</li>
     *     <li>The {@code swap} method is called to swap the elements at indices {@code index} and {@code i}.
     *     This places the minimum element in its correct sorted position.</li>
     *     <li>The process repeats until the entire list is sorted.</li>
     * </ul>
     * {@code selectionInc} method implements the Selection Sort algorithm to sort the given {@code list} of Comparable
     * objects in ascending order.
    ...
    /**
     * {@code selectionDec} that performs the Selection Sort algorithm on an list of {@link java.lang.Comparable
     * Comparable} objects.
     * The sorting is done in descending order.
     * <ul>
     *     <li>The method takes in an list of Comparable objects, {@code list}, and performs the Selection Sort
     ...
     *     between
     *     the current index {@code j} and the current maximum {@code index} index.</li>
     *     <li>After the inner loop completes, the maximum element in the unsorted portion of the list is found, and
     *     its index is stored in {@code index}.</li>
     *     <li>The {@code swap} method is called to swap the elements at indices {@code index} and {@code i}.
     *     This places the maximum element in its correct sorted position.</li>
     *     <li>The process repeats until the entire list is sorted.</li>
     * </ul>
     * {@code selectionDec} method implements the Selection Sort algorithm to sort the given {@code list} of Comparable
     * objects in descending order.
    ...
    /**
     * {@code selection} method takes an list {@code list} of type {@code T} and an instance of
     * {@code SortFunctional<T>} as parameters.
     * <ul>
     ...
     *     <li>The outer loop continues until all elements have been sorted in ascending order.</li>
     * </ul>
     * {@code selection} this method is to perform selection sort on the {@code list} using the comparison logic
     * defined by the {@code mz.SortFunctional} instance.
     * It iterates through the list and selects the minimum element in each iteration, swapping it with the current
     * position.
    ...
    /**
     * {@code selectionInc} that performs the Selection Sort algorithm on an list of {@link java.lang.Comparable
     * Comparable} objects.
     * The sorting is done in ascending order.
     * <ul>
     *     <li>The method takes in an list of Comparable objects, {@code list}, and performs the Selection Sort
     ...
     *     between
     *     the current index {@code j} and the current minimum {@code index} index.</li>
     *     <li>After the inner loop completes, the minimum element in the unsorted portion of the list is found, and its
     *     index is stored in {@code index}.</li>
     *     <li>The {@code swap} method is called to swap the elements at indices {@code index} and {@code i}.
     *     This places the minimum element in its correct sorted position.</li>
     *     <li>The process repeats until the entire list is sorted.</li>
     * </ul>
     ...
     *     portion of the list.</li>
     *     <li>Inside the inner loop, the {@code maxIndex} method is called to find the index of the maximum element
     *     between the current index {@code j} and the current maximum {@code index} index.</li>
     *     <li>After the inner loop completes, the maximum element in the unsorted portion of the list is found, and
     *     its index is stored in {@code index}.</li>
     *     <li>The {@code swap} method is called to swap the elements at indices {@code index} and {@code i}.
     *     This places the maximum element in its correct sorted position.</li>
    ...
    /**
     * {@code selection} method takes an list {@code list} of type {@code T}, two integer parameters {@code left} and
     * {@code right},
     * and an instance of {@code mz.SortFunctional<T>} as parameters.
     * <ul>
     *     <li>It starts by initializing a {@code for} loop that iterates from {@code i = left} to {@code (right - 1)}.
