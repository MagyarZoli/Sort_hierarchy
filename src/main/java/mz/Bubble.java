...
extends Selection {
     ...
     * </ul>
     * {@code bubbleInc} method implements the Bubble Sort algorithm to sort the given array of {@code Comparable} objects in ascending order.
     ...
     *     <li>The {@code swap} method is called to swap the elements at indices {@code (j - 1)} and {@code j}.</li>
     * </ul>
     * {@code bubbleInc} method implements the Bubble Sort algorithm to sort the given array of {@code Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the array is sorted.
     * @param       array to be arranged.
     * @see         mz.SortSwap#swap(Comparable[], int, int)
     */
     ...
     * </ul>
     * {@code bubble} method implements the Bubble Sort algorithm to sort the given array of {@code Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the array is sorted.
     * @param       array to be arranged.
     * @param       functional lambda expression for comparison.
     ...
     * </ul>
     * {@code bubble} method implements the Bubble Sort algorithm to sort the given array of {@link java.lang.Comparable Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the array is sorted.
     * @param       array to be arranged.
     * @param       left the value in the array must be smaller than a {@code right} parameter.
     * @param       right the value in the array must be greater than a {@code left} parameter.
    ...
    /**
     * {@code bubbleInc} that performs the Bubble Sort algorithm on a list of {@link java.lang.Comparable Comparable} objects.
     * The sorting is done in ascending order.
     * <ul>
     *     <li>The method takes in an {@code list} of Comparable objects, list, and performs the Bubble Sort algorithm on it.</li>
     *     <li>The {@link java.lang.SuppressWarnings @SuppressWarnings}{@code ("unchecked")} annotation is used to suppress compiler warnings related to type
     *     safety when using the {@link java.lang.Comparable#compareTo(Object) compareTo} method.</li>
     *     <li>The method starts with defining the length of the {@code list} as {@code n}.</li>
     *     <li>Two nested {@code for} loops are used for iterating over the elements of the list and comparing adjacent elements to perform the sorting.</li>
     *     <li>The outer loop iterates from 0 to {@code (n - 1)} and represents the number of passes performed in the Bubble Sort algorithm.</li>
     *     <li>The inner loop iterates from 1 to {@code (n - i) - 1} and represents the range of elements to be compared in each pass.
     *     The {@code (n - i)} part is because the largest {@code i} elements are already sorted and placed at the end in each pass.</li>
     *     <li>Inside the inner loop, an {@code if} condition is used to compare adjacent elements. If the element at
     ...
     *     <li>The {@code swap} method is called to swap the elements at indices {@code (j - 1)} and {@code j}.</li>
     * </ul>
     * {@code bubbleInc} method implements the Bubble Sort algorithm to sort the given list of {@code Comparable} objects in ascending order.
    ...
    /**
     * {@code bubbleDec} that performs the Bubble Sort algorithm on a list of {@link java.lang.Comparable Comparable} objects.
     * The sorting is done in descending order.
     * <ul>
     *     <li>The method takes in an {@code list} of Comparable objects, list, and performs the Bubble Sort algorithm on it.</li>
     *     <li>The {@link java.lang.SuppressWarnings @SuppressWarnings}{@code ("unchecked")} annotation is used to suppress compiler warnings related to type
     ...
     *     <li>The {@code swap} method is called to swap the elements at indices {@code (j - 1)} and {@code j}.</li>
     * </ul>
     * {@code bubbleInc} method implements the Bubble Sort algorithm to sort the given list of {@code Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the list is sorted.
     * @param       list to be arranged.
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     *     <li>The outer loop iterates from index <i>0</i> to the last index of the list {@code for (int i = 0; i < n; i++)}.</li>
     ...
     * </ul>
     * {@code bubble} method implements the Bubble Sort algorithm to sort the given list of {@link java.lang.Comparable Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the list is sorted.
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         SortFunctional#functionalCompareTo(Comparable, Comparable)
     ...
     *     the {@code functionalCompareTo} method from the {@code SortFunctional} interface.</li>
     *     <li>If the comparison returns {@code true} (indicating that the elements are out of order),
     *     it swaps the elements by calling the {@code swap} method and passing the list and the indices {@code (j - 1)} and {@code j}.</li>
     *     <li>The process continues until the outer loop completes, resulting in the range being sorted in ascending order.</li>
     * </ul>
     * {@code bubble} method implements the Bubble Sort algorithm to sort the given list of {@link java.lang.Comparable Comparable} objects in descending order.
     * It repeatedly compares adjacent elements and swaps them if necessary until the list is sorted.
     ...
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void bubble(List<L> list, int left, int right, SortFunctional<Comparable> functional) {
        for (int i = left; i < right; i++) {
            for (int j = 1; j < (right - i); j++) {
                if (functional.functionalCompareTo(list.get(j - 1), list.get(j))) {
                    swap(list, (j - 1), j);
