...
extends Bogo {
     ...
     * @see         mz.Permutation#permuteComparableInc(List)
     */
     ...
     * can be quite inefficient for larger lists.
     * @param       list to be arranged.
     * @see         mz.Permutation#permuteComparableDec(List)
     */
     ...
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         mz.Permutation#permuteComparable(List, SortFunctional)
     */
     ...
     * @see         mz.Permutation#permuteComparableInc(List, int, int)
     */
     ...
     * @param       left the starting index of the subList.
     * @param       right the ending index of the subList.
     * @see         mz.Permutation#permuteComparableDec(List, int, int)
     */
     ...
     * @param       right the ending index of the subList.
     * @param       functional lambda expression for comparison.
     * @see         mz.Permutation#permuteComparable(List, int, int, SortFunctional)
     */
     ...
     * @see         mz.Permutation#permute(List, int, List)
     * @see         mz.Bogo#isSortedInc(List)
     */
     ...
     * @param       right the ending index of the sublist.
     * @return      The original list ascending order.
     * @see         mz.Permutation#permute(List, int, int, List)
     * @see         mz.Bogo#isSortedInc(List)
     */
