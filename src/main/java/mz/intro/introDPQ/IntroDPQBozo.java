...
import mz.Sort;
import mz.intro.IntroBozo;

/**
 * IntroDPQ (Dual Pivot Quick) Bozo Sort is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Bozo Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Bozo Sort monitors the recursion depth during the sorting process.
 ...
 * Additionally, for small subarrays, Intro switches to Bozo Sort, which has good performance for small input sizes.
 * @since       1.2
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQBozo
extends IntroBozo
implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Bozo Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Bozo Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     * The basic idea behind Intro Sort is to start with Dual Pivot Quick Sort, which is known for its efficiency on average,
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Bozo Sort, which has good performance for small input sizes.<br><br>
     * <b>Example:</b>
     * <ol>
     ...
     *     it directly to sort the sub-array using a Intro Bozo sorting algorithm.
