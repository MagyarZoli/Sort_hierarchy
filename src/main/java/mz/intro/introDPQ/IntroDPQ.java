...
extends Intro<T> {
     ...
     * @see         mz.intro.Intro#introRecursiveInc(Comparable[], int, int, int)
     ...
     * @see         mz.intro.Intro#introRecursiveDec(Comparable[], int, int, int)
     ...
     * @see         mz.intro.Intro#introRecursive(Comparable[], int, int, int, SortFunctional)
