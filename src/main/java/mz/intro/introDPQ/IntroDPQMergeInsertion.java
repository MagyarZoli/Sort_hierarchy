...
import mz.Sort;
import mz.intro.IntroMergeInsertion;

/**
 * IntroDPQ (Dual Pivot Quick) Merge Insertion Sort is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Merge Insertion Sort.
 ...
 * To mitigate the risk of Dual Pivot Quick Sort's worst-case behavior, Merge Insertion Sort monitors the recursion depth during the sorting process.
 ...
 * Additionally, for small subarrays, Intro switches to Merge Insertion Sort, which has good performance for small input sizes.
 * @since       1.2
 * @author      <a href=https://github.com/MagyarZoli>Magyar Zoltán</a>
 */
@SuppressWarnings("rawtypes")
public class IntroDPQMergeInsertion
extends IntroMergeInsertion
implements IntroDPQ<Comparable> {

    /**
     * <b>IntroDPQ (Dual Pivot Quick) Merge Insertion Sort:</b><br>
     * Is a hybrid sorting algorithm that combines the strengths of Dual Pivot Quick Sort and Merge Insertion Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     * The basic idea behind Intro Sort is to start with Dual Pivot Quick Sort, which is known for its efficiency on average,
     ...
     * If the depth exceeds a certain threshold, the algorithm switches to HeapSort,
     * which guarantees worst-case <em>O(n log(n))</em> time complexity but has higher overhead.
     * Additionally, for small subarrays, Intro switches to Merge Insertion Sort, which has good performance for small input sizes.<br><br>
     * <b>Example:</b>
     * <ol>
     ...
     *     it directly to sort the sub-array using a Intro Merge Insertion sorting algorithm.
    ...
    public Sort sortThreadClass() {
        return new IntroDPQMergeInsertion();
    }
}