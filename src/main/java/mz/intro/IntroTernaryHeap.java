...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Ternary Heap Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
