...
/**
 * Intro Sort is a hybrid sorting algorithm that combines the strengths of Quick Sort and Bogo Sort.
...
implements Intro<Comparable> {
     ...
     * Is a hybrid sorting algorithm that combines the strengths of Quick Sort and Bozo Sort.
     * It aims to provide fast average-case performance while maintaining worst-case guarantees.
     * The basic idea behind Intro Sort is to start with Quick Sort, which is known for its efficiency on average,
     ...
     *     and the sorting algorithm switches to another sorting method is Bozo Sort</li>
     ...
     * algorithm with a switch to another sorting algorithm Bozo Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
     ...
     * Stability:               <b>No</b>
     * @see         mz.intro.introDPQ.IntroDPQBozo#IntroDPQBozo() IntroDPQBozo
     */
    public IntroBozo() {}
