...
implements Intro<Comparable> {
     ...
     * algorithm with a switch to another sorting algorithm Merge Insertion Sort when the recursion depth exceeds a specified threshold {@code maxDepth}.
