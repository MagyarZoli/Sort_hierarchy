...
extends Quick {
     ...
     * @param       array to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         mz.Quick3#quick3(Comparable[], int, int, SortFunctional)
     */
     ...
     * @param       right the value in the array must be greater than a {@code left} parameter.
     * @param       functional lambda expression for comparison.
     * @see         mz.Quick3#partition(Comparable[], int, int, SortFunctional)
     */
     ...
     * @param       list to be arranged.
     * @see         mz.Quick3#quick3Inc(List, int, int)
     */
     ...
     * It performs a three-way partitioning and recursively sorts the left and right partitions until the entire list is sorted.
     * @param       list to be arranged.
     * @see         mz.Quick3#quick3Dec(List, int, int)
     */
     ...
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         mz.Quick3#quick3(List, int, int, SortFunctional)
     */
     ...
     * @see         mz.Quick3#partition3Inc(List, int, int)
     */
     ...
     * @param       left the value in the list must be smaller than a {@code right} parameter.
     * @param       right the value in the list must be greater than a {@code left} parameter.
     * @see         mz.Quick3#partition3Dec(List, int, int)
     */
     ...
     * @param       right the value in the list must be greater than a {@code left} parameter.
     * @param       functional lambda expression for comparison.
     * @see         mz.Quick3#partition(List, int, int, SortFunctional)
     */
