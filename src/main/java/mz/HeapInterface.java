...
extends Sorter<T>, SortSwap<T> {
     ...
     * @see         mz.HeapInterface#heapifyInc(List, int, int)
     ...
     * it into a max heap and repeatedly extracting the maximum element from the heap.
     * @param       list to be arranged.
     * @see         mz.HeapInterface#heapifyDec(List, int, int)
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         mz.HeapInterface#heapify(List, int, int, SortFunctional)
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     * @param       n of the list.
     * @param       i the current element
     * @see         mz.HeapInterface#heapSplitInc(List, int, int)
     * @see         mz.HeapInterface#heapifyInc(List, int, int)
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     * @param       n of the list.
     * @param       i the current element
     * @see         mz.HeapInterface#heapSplitDec(List, int, int)
     * @see         mz.HeapInterface#heapifyDec(List, int, int)
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     * @param       i the current element
     * @param       functional lambda expression for comparison.
     * @see         mz.HeapInterface#heapSplit(List, int, int, SortFunctional)
     * @see         mz.SortSwap#swap(List, int, int)
     */
     ...
     * @param       functional lambda expression for comparison.
     * @return      the value of {@code largest}
     * @see         mz.HeapInterface#heapChild(List, int, int, int, SortFunctional)
     */
