...
extends Selection {
     ...
     * Stability:               <b>Yes</b>
     * @see         mz.intro.IntroPancake#IntroPancake() IntroPancake
     */
    public Pancake() {}
     ...
     * @param       array to be arranged.
     * @see         mz.SortFind#findMaxIndex(Comparable[], int)
     * @see         mz.SortSwap#flip(Comparable[], int)
     */
     ...
     * @param       array to be arranged.
     * @see         mz.SortFind#findMinIndex(Comparable[], int)
     * @see         mz.SortSwap#flip(Comparable[], int)
     */
     ...
     * @see         mz.SortFind#findMaxIndex(Comparable[], int, int)
     * @see         mz.SortSwap#flip(Comparable[], int, int)
     */
     ...
     * @param       list to be arranged.
     * @see         mz.SortFind#findMaxIndex(List, int)
     * @see         mz.SortSwap#flip(List, int)
     */
     ...
     * @param       list to be arranged.
     * @see         mz.SortFind#findMinIndex(List, int)
     * @see         mz.SortSwap#flip(List, int)
     */
     ...
     * @param       list to be arranged.
     * @param       functional lambda expression for comparison.
     * @see         mz.SortFind#findIndex(List, int, SortFunctional)
     * @see         mz.SortSwap#flip(List, int, int)
     */
     ...
     * @see         mz.SortFind#findMaxIndex(List, int, int)
     * @see         mz.SortSwap#flip(List, int, int)
     */
     ...
     * @param       right specific range of the list.
     * @param       functional lambda expression for comparison.
     * @see         mz.SortFind#findIndex(List, int, int, SortFunctional)
     * @see         mz.SortSwap#flip(List, int, int)
     */
