...
extends Selection {
    ...
    public void sortListFun(List<? extends Comparable> list, SortFunctional<Comparable> functional) {
        doubleSelection(list, functional);
    }
     ...
     * @param       list to be arranged.
     * @see         mz.SortFind#findMinimumIndex(List, int, int)
     * @see         mz.SortFind#findMaximumIndex(List, int, int)
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void doubleSelectionInc(List<L> list) {
        int n = list.size(), left = 0, right = (n - 1);
        while (left < right) {
            int minIndex = left, maxIndex = right;
            for (int j = left; j <= right; j++) {
                minIndex = findMinimumIndex(list, j, minIndex);
     ...
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void doubleSelectionDec(List<L> list) {
        int n = list.size(), left = 0, right = (n - 1);
        while (left < right) {
            int minIndex = left, maxIndex = right;
            for (int j = left; j <= right; j++) {
    ...
    /**
     * {@code doubleSelection} method takes a list {@code list} of type {@link java.lang.Comparable Comparable}
     * and an instance of the {@code SortFunctional<Comparable>} interface as parameters.
     * <ul>
     ...
     * @see         mz.SortFind#findValueIndex(List, int, int, SortFunctional)
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void doubleSelection(List<L> list, SortFunctional<Comparable> functional) {
        int n = list.size(), left = 0, right = (n - 1);
        SortFunctional<Comparable> functionalReverse = functionalComparableToReverse(functional);
        while (left < right) {
            int valueIndex = left, valueReverseIndex = right;
            for (int j = left; j <= right; j++) {
                valueIndex = findValueIndex(list, j, valueIndex, functional);
     ...
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void doubleSelectionInc(List<L> list, int left, int right) {
        while (left < right) {
            int minIndex = left, maxIndex = right;
            for (int j = left; j <= right; j++) {
                minIndex = findMinimumIndex(list, j, minIndex);
     ...
     * @see         mz.SortSwap#swap(List, int, int)
     */
    protected <L extends Comparable> void doubleSelectionDec(List<L> list, int left, int right) {
        while (left < right) {
            int minIndex = left, maxIndex = right;
            for (int j = left; j <= right; j++) {
                minIndex = findMinimumIndex(list, j, minIndex);
